...
function ChucklePostAI(AI_option) {
    ...
    aiDiv.innerHTML = `
      <div class="ai-container">
        <div class="ai-header">
          ...
          <div class="ai-title">乌龟のAI摘要</div>
          <div class="ai-tag">gemini-1.5-flash</div>
        </div>
  ...
  var chucklePostAI = {
    ...
    fetchAISummary: async function(content) {
      ...
      try {
        const response = await fetch('https://notionai.dreamofinfinity1.top/api/summary?token=590123', {
          method: "POST",
          headers: {
